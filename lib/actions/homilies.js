  ...
  try {
    ...
    const { data, error } = await supabase
      ...
      .insert({
        ...
        context: homily.context || null,
        definitions: homily.definitions || null,
        readings: homily.readings || null,
        first_set_of_questions: homily.first_set_of_questions || null,
        second_set_of_questions: homily.second_set_of_questions || null,
        final_draft: homily.final_draft || null,
        status: homily.status || null,
      })
      .select()
      .single();
